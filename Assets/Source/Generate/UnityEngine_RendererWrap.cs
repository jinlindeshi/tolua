...
public class UnityEngine_RendererWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("shadingRate", get_shadingRate, set_shadingRate);
		...
		L.RegVar("isLodRenderer", get_isLodRenderer, null);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_shadingRate(IntPtr L)
	{
		object o = null;
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.Renderer obj = (UnityEngine.Renderer)o;
			UnityEngine.Rendering.ShadingRateFragmentSize ret = obj.shadingRate;
			ToLua.Push(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index shadingRate on a nil value");
		}
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_isLodRenderer(IntPtr L)
	{
		object o = null;
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.Renderer obj = (UnityEngine.Renderer)o;
			bool ret = obj.isLodRenderer;
			LuaDLL.lua_pushboolean(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index isLodRenderer on a nil value");
		}
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_shadingRate(IntPtr L)
	{
		object o = null;
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.Renderer obj = (UnityEngine.Renderer)o;
			UnityEngine.Rendering.ShadingRateFragmentSize arg0 = (UnityEngine.Rendering.ShadingRateFragmentSize)ToLua.CheckObject(L, 2, typeof(UnityEngine.Rendering.ShadingRateFragmentSize));
			obj.shadingRate = arg0;
			return 0;
		}
		catch(Exception e)
		{
