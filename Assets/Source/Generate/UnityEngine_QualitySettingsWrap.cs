...
public class UnityEngine_QualitySettingsWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("GetMaxVGPersistentBufferSize", GetMaxVGPersistentBufferSize);
		L.RegFunction("GetMinVGStreamingBufferSize", GetMinVGStreamingBufferSize);
		L.RegFunction("GetMaxVGStreamingBufferSize", GetMaxVGStreamingBufferSize);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int GetMaxVGPersistentBufferSize(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 0);
			int o = UnityEngine.QualitySettings.GetMaxVGPersistentBufferSize();
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int GetMinVGStreamingBufferSize(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 0);
			int o = UnityEngine.QualitySettings.GetMinVGStreamingBufferSize();
			LuaDLL.lua_pushinteger(L, o);
			return 1;
		}
		catch (Exception e)
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int GetMaxVGStreamingBufferSize(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 0);
			int o = UnityEngine.QualitySettings.GetMaxVGStreamingBufferSize();
			LuaDLL.lua_pushinteger(L, o);
			return 1;
		}
		catch (Exception e)
