...
public class UnityEngine_InputWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("mouseDisplayIndex", get_mouseDisplayIndex, null);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_mouseDisplayIndex(IntPtr L)
	{
		try
		{
			LuaDLL.lua_pushinteger(L, UnityEngine.Input.mouseDisplayIndex);
			return 1;
		}
		catch (Exception e)
		{
