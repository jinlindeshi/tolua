...
public class UnityEngine_AnimationClipWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("TriggerCloudResourceDownload", TriggerCloudResourceDownload);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int TriggerCloudResourceDownload(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 1);
			UnityEngine.AnimationClip obj = (UnityEngine.AnimationClip)ToLua.CheckObject(L, 1, typeof(UnityEngine.AnimationClip));
			obj.TriggerCloudResourceDownload();
			return 0;
		}
		catch (Exception e)
		{
