...
public class UnityEngine_PhysicsWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("SwitchToCurrentRenderServicePhysicsScene", SwitchToCurrentRenderServicePhysicsScene);
	...
	static int SwitchToCurrentRenderServicePhysicsScene(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 1);
			string arg0 = ToLua.CheckString(L, 1);
			UnityEngine.Physics.SwitchToCurrentRenderServicePhysicsScene(arg0);
			return 0;
		}
		catch (Exception e)
		{
