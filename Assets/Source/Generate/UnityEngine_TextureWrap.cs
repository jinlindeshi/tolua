...
public class UnityEngine_TextureWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("TriggerOriginalTextureDownload", TriggerOriginalTextureDownload);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int TriggerOriginalTextureDownload(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 1);
			UnityEngine.Texture obj = (UnityEngine.Texture)ToLua.CheckObject<UnityEngine.Texture>(L, 1);
			obj.TriggerOriginalTextureDownload();
			return 0;
		}
		catch (Exception e)
		{
